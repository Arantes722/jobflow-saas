    ...
    try {
      ...
      if (error) {
        if (error.message.includes("already registered")) {
          ...
          setServerError("Please check your email and password requirements.")
        } else {
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="px-8 pt-8 pb-6">
            ...
            <p className="text-gray-600 text-sm mt-2">
              Start tracking your job applications and land your dream role
            </p>
          </div>
          ...
          <div className="px-8 pb-8 space-y-5">
            ...
            <div>
              ...
              {errors.confirmPassword && (
                <p className="text-red-600 text-sm mt-1.5 font-medium">{errors.confirmPassword}</p>
              )}
            </div>
